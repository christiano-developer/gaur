...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loginData = {
      ...
      ...(credentials.two_factor_code && { two_factor_code: credentials.two_factor_code }),
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-primary/80 p-4">
      <Card className="w-full max-w-md p-8 bg-white/95 backdrop-blur-sm shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="badge_number" className="block text-sm font-medium text-gray-700 mb-2">
              Badge Number
            </label>
            <Input
              id="badge_number"
          ...
          <Button
            type="submit"
            disabled={isLoading || !credentials.badge_number || !credentials.password}
